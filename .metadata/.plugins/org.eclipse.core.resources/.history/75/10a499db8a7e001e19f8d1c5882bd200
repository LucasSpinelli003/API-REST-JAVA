...
public class ContatoSeguradoService {

	private ContatoSeguradoDao contatoSeguradoDao;
	private SeguradoDao seguradoDao;
	
	
	public ContatoSeguradoService() throws ClassNotFoundException, SQLException {
	...
	public ContatoSegurado pesquisar(int id) throws ClassNotFoundException, SQLException, IdNotFoundException{
		...
		if (cS.getSegurado() != null) {
			Segurado s = seguradoDao.pesquisar(cS.getSegurado().getId());
			cS.setSegurado(s);
		}
		return cS;
	}
