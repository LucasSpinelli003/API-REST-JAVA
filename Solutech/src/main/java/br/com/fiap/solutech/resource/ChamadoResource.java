...
@Path("/chamado") //http://localhost:8080/07-WebApi/api/produto
public class ChamadoResource {
	...
	public Response cadastrar(Chamado chamado, @Context UriInfo uri) throws ClassNotFoundException, SQLException {
		try {
