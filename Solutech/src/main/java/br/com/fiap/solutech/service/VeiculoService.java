...
public class VeiculoService {
	...
	private void validar(Veiculo veiculo) throws BadInfoException {
		...
		if (veiculo.getAlteracoes() == null || veiculo.getAlteracoes().length() > 200) {
			throw new BadInfoException("Tipo de carroceria invalido, nao pode ser nulo e no maximo 200 caracteres");
		}
	}
